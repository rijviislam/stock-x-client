...
//             >
//               Sort <img className="w-5 h-5" src={Sort} alt="Sort" />
//             </div>
//             <ul
//               tabIndex={0}
...
//                     sortOrder === "lowToHigh" ? "bg-teal-200" : ""
//                   }`}
//                 >
//                   Price: Low to High
//                 </button>
...
//                   className={`block px-4 py-2 ${
//                     sortOrder === "highToLow" ? "bg-teal-200" : ""
//                   }`}
//                 >
//                   Price: High to Low
//                 </button>
...
export default function Home() {
  ...
  // Fetch products with pagination and search name
  ...
  // useEffect(() => {
  //   handleSortDate(); // Call the sort function to ensure newest products are shown first
  ...
  const handleSortChange = (order) => {
    setSortOrder(order);
    setSortByDate(false); // Ensure sorting by date is disabled when sorting by price
  };
